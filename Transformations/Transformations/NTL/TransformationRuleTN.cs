...
namespace NMF.Transformations
{
        ...
        where T : class
    {
        ...
        {
            var createOutput = this.GetType().GetRuntimeMethod("CreateOutput", new[] { typeof(object[]), typeof(ITransformationContext) });
            needDependencies = createOutput.DeclaringType != typeof(TransformationRule<T>);
        }
