...
namespace NMF.Expressions
{
    ...
    {
        private static bool isT1Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T1).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T1).GetTypeInfo());
    ...
    {
        private static bool isT1Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T1).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T1).GetTypeInfo());
        private static bool isT2Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T2).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T2).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, TResult> : ObservableStaticMethodCall<T1, T2, T3, TResult>
    {
        private static bool isT1Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T1).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T1).GetTypeInfo());
        private static bool isT2Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T2).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T2).GetTypeInfo());
        private static bool isT3Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T3).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T3).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, TResult>
    {
        ...
        private static bool isT2Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T2).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T2).GetTypeInfo());
        private static bool isT3Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T3).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T3).GetTypeInfo());
        private static bool isT4Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T4).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T4).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, T5, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, T5, TResult>
    {
        ...
        private static bool isT3Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T3).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T3).GetTypeInfo());
        private static bool isT4Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T4).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T4).GetTypeInfo());
        private static bool isT5Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T5).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T5).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, T5, T6, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, T5, T6, TResult>
    {
        ...
        private static bool isT4Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T4).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T4).GetTypeInfo());
        private static bool isT5Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T5).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T5).GetTypeInfo());
        private static bool isT6Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T6).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T6).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, T5, T6, T7, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, T5, T6, T7, TResult>
    {
        ...
        private static bool isT5Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T5).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T5).GetTypeInfo());
        private static bool isT6Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T6).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T6).GetTypeInfo());
        private static bool isT7Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T7).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T7).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, TResult>
    {
        ...
        private static bool isT6Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T6).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T6).GetTypeInfo());
        private static bool isT7Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T7).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T7).GetTypeInfo());
        private static bool isT8Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T8).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T8).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>
    {
        ...
        private static bool isT7Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T7).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T7).GetTypeInfo());
        private static bool isT8Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T8).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T8).GetTypeInfo());
        private static bool isT9Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T9).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T9).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>
    {
        ...
        private static bool isT8Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T8).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T8).GetTypeInfo());
        private static bool isT9Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T9).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T9).GetTypeInfo());
        private static bool isT10Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T10).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T10).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>
    {
        ...
        private static bool isT9Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T9).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T9).GetTypeInfo());
        private static bool isT10Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T10).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T10).GetTypeInfo());
        private static bool isT11Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T11).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T11).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>
    {
        ...
        private static bool isT10Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T10).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T10).GetTypeInfo());
        private static bool isT11Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T11).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T11).GetTypeInfo());
        private static bool isT12Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T12).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T12).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TResult>
    {
        ...
        private static bool isT11Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T11).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T11).GetTypeInfo());
        private static bool isT12Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T12).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T12).GetTypeInfo());
        private static bool isT13Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T13).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T13).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult>
    {
        ...
        private static bool isT12Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T12).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T12).GetTypeInfo());
        private static bool isT13Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T13).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T13).GetTypeInfo());
        private static bool isT14Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T14).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T14).GetTypeInfo());
    ...
    internal class ObservablePromotionMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TResult> : ObservableStaticMethodCall<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TResult>
    {
        ...
        private static bool isT13Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T13).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T13).GetTypeInfo());
        private static bool isT14Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T14).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T14).GetTypeInfo());
        private static bool isT15Collection = typeof(INotifyEnumerable).GetTypeInfo().IsAssignableFrom(typeof(T15).GetTypeInfo()) || typeof(IEnumerableExpression).GetTypeInfo().IsAssignableFrom(typeof(T15).GetTypeInfo());
